...
$.fn.uploadFile.createAjaxForm = function (obj,group,s)
{
	...
	var statusbar = $("<div class='ajax-file-upload-statusbar' style='display: none;'></div>");
	var filename  = $("<div class='ajax-file-upload-filename' style='display: none;'></div>").appendTo(statusbar);
	var progressDiv   =$("<div class='ajax-file-upload-progress' style='display: none;'>").appendTo(statusbar).hide();
	var progressbar   =$("<div class='ajax-file-upload-bar' style='display: none;'></div>").appendTo(progressDiv);
	var abort = $("<div class='ajax-file-upload-red' style='display: none;'>Abort</div>").appendTo(statusbar).hide();
	var cancel = $("<div class='ajax-file-upload-red' style='display: none;'>Cancel</div>").appendTo(statusbar).hide();
	var done = $("<div class='ajax-file-upload-green' style='display: none;'>Done</div>").appendTo(statusbar).hide();
    ...
    forceSync: false,
//    data:s.formData,
    data:s.onChangeData.call(s.formData),    
