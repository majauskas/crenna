...
//        return false;
    ...
    embed = function(targetID){
        ...
        //added by Minde, needs for ipad, iphone
        if((/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent))){
        	height = "1000px"; 
        	$(targetNode).parent().css("height","1000px");
        }
        

        targetNode.innerHTML = '<object  url="' +url +'"  data="' +url +'" type="application/pdf" width="' +width +'" height="' +height +'"></object>';
